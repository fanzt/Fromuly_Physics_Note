...
&emsp;&emsp;由于物体的热容 $C_v$ 总是大于零的，我们可以知道物体的能量是温度的单调增函数。这意味着，当物体处于最低可能的温度（即绝对零度）时，其本身应当处于具有最小可能能量的状态。假想地将物体划分为许多部分，将其总能量视为所有部分能量的和，由于热平衡我们知道这些所有小的部分也都需要处于绝对零度，即处于最低能量状态。
&emsp;&emsp;从量子统计角度来说，最低能量的状态显然是一个确定的量子态——基态。量子态的确定性意味着意味着该状态下体系的统计权重仅能等于一，这也意味着该状态下物体的熵必须为零，而该结论被称为能斯特定理。
